...
public class RemoteReceiverDecompressorLoggingTests {
    ...
    public void CancelReceiveLoggingTest() throws Exception {
        ...
        verify(mockApplicationLogger).Log(testRemoteReceiverDecompressor, LogLevel.Information, "Receive operation cancelled.");
        verifyNoMoreInteractions(mockApplicationLogger);
    }
}
