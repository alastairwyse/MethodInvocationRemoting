 ...
 */
class TestDiskBytesReadMetric extends AmountMetric {

    public TestDiskBytesReadMetric(long bytesRead) {
        super.name = "DiskBytesRead";
        super.description = "A single instance of this metric represents the number of bytes read during a disk read operation.";
        super.amount = bytesRead;
    }
}
