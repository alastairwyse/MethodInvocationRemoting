 ...
 */
class TestDiskWriteTimeMetric extends IntervalMetric {

    public TestDiskWriteTimeMetric(){
        super.name = "DiskWriteTime";
        super.description = "Represents the amount of time taken to perform a write operation to disk.";
    }
}
