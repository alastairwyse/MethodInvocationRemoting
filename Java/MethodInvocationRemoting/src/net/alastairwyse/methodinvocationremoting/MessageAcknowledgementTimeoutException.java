 ...
 */
public class MessageAcknowledgementTimeoutException extends Exception {

    /**
     * Initialises a new instance of the MessageAcknowledgementTimeoutException class.
     ...
     */
    public MessageAcknowledgementTimeoutException(String message, Throwable cause) {
        super(message, cause);
    }
}
