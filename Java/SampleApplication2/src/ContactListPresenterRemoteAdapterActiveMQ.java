 ...
 */
public class ContactListPresenterRemoteAdapterActiveMQ implements IContactListPresenter {
    ...
    /**
     * Initialises a new instance of the ContactListPresenterRemoteAdapterActiveMQ class.
     ...
     */
    public ContactListPresenterRemoteAdapterActiveMQ(String connectUriName, String outgoingQueueName, String incomingQueueName, String requestFilter, String responseFilter) {
     ...
     * As the ContactListPresenterRemoteAdapterActiveMQ creates additional threads as part of the MethodInvocationRemoting framework, this method can be used to determine if any exceptions have occurred on spawned threads.
