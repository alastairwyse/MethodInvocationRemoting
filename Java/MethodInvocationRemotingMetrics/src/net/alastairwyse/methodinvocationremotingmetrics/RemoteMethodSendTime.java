 ...
 * @author Alastair Wyse
  */
public class RemoteMethodSendTime extends IntervalMetric {
    public RemoteMethodSendTime() {
        super.name = "RemoteMethodSendTime";
        super.description = "The time taken to send and execute a remote method call";
    }
}
