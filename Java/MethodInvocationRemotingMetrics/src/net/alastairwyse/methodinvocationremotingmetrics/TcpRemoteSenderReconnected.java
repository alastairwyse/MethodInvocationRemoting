 ...
 */
public class TcpRemoteSenderReconnected extends CountMetric {
    public TcpRemoteSenderReconnected() {
        super.name = "TcpRemoteSenderReconnected";
        super.description = "The number of times a TcpRemoteSender object reconnected";
    }
}
