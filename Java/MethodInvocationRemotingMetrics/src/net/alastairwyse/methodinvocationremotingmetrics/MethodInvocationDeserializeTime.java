 ...
 */
public class MethodInvocationDeserializeTime extends IntervalMetric {
    public MethodInvocationDeserializeTime() {
        super.name = "MethodInvocationDeserializeTime";
        super.description = "The time taken to deserialize a method invocation";
    }
}
