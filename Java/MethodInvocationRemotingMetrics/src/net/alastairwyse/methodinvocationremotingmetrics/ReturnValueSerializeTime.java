 ...
 */
public class ReturnValueSerializeTime extends IntervalMetric {
    public ReturnValueSerializeTime() {
        super.name = "ReturnValueSerializeTime";
        super.description = "The time taken to serialize a return value";
    }
}
