 ...
 */
public class TcpRemoteReceiverReconnected extends CountMetric {
    public TcpRemoteReceiverReconnected() {
        super.name = "TcpRemoteReceiverReconnected";
        super.description = "The number of times a TcpRemoteReceiver object reconnected";
    }
}
