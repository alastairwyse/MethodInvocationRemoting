 ...
 */
public class MethodInvocationSerialized extends CountMetric {
    public MethodInvocationSerialized() {
        super.name = "MethodInvocationSerialized";
        super.description = "The number of method invocations serialized";
    }
}
