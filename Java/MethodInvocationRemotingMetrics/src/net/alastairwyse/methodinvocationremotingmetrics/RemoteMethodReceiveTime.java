 ...
 */
public class RemoteMethodReceiveTime extends IntervalMetric {
    public RemoteMethodReceiveTime() {
        super.name = "RemoteMethodReceiveTime";
        super.description = "The time taken to receive and execute a remote method call";
    }
}
