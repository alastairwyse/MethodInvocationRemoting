 ...
 */
public class ReturnValueDeserializeTime extends IntervalMetric {
    public ReturnValueDeserializeTime() {
        super.name = "ReturnValueDeserializeTime";
        super.description = "The time taken to deserialize a return value";
    }
}
