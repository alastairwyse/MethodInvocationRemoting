 ...
 */
public class ReceivedMessageSize extends AmountMetric {
    public ReceivedMessageSize(long messageSize) {
        super.name = "ReceivedMessageSize";
        super.description = "The size of a received message";
        super.amount = messageSize;
    }
}
