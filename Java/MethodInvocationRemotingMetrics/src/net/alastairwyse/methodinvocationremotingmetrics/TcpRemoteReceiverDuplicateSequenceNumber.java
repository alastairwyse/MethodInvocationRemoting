 ...
 */
public class TcpRemoteReceiverDuplicateSequenceNumber extends CountMetric {
    public TcpRemoteReceiverDuplicateSequenceNumber() {
        super.name = "TcpRemoteReceiverDuplicateSequenceNumber";
        super.description = "The number of times a TcpRemoteReceiver object received a message with a duplicate sequence number";
    }
}
