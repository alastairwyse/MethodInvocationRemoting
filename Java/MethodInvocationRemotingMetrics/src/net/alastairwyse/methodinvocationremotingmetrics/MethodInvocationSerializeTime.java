 ...
 */
public class MethodInvocationSerializeTime extends IntervalMetric {
    public MethodInvocationSerializeTime() {
        super.name = "MethodInvocationSerializeTime";
        super.description = "The time taken to serialize a method invocation";
    }
}
