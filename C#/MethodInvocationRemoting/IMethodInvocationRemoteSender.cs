...
namespace MethodInvocationRemoting
{
    //******************************************************************************
    //
    // Interface: IMethodInvocationRemoteSender
    //
    //******************************************************************************
    /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="T:MethodInvocationRemoting.IMethodInvocationRemoteSender"]/*'/>
    public interface IMethodInvocationRemoteSender
    {
        ...
        object InvokeMethod(IMethodInvocation inputMethodInvocation);
        ...
        void InvokeVoidMethod(IMethodInvocation inputMethodInvocation);
    }
}
