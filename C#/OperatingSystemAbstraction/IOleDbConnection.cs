...
namespace OperatingSystemAbstraction
{
    ...
    //
    //******************************************************************************
    /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="T:OperatingSystemAbstraction.IOleDbConnection"]/*'/>
    public interface IOleDbConnection : IDisposable
    {
